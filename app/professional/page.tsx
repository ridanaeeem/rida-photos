					...
					{filters.length === 0 ? (
						<div>
							<div className="pb-10" id="halfalive">
								...
								/>
								<div className="grid grid-cols-3 md:grid-cols-5 grid-auto-rows minmax(150px, auto) mx-1 md:mx-3">
									{collections["halfalive"].slice(0, 4).map((photo: CollectionPhotoProps) => (
										<CollectionThumbnail
											key={photo.imageSrc}
											photo={photo}
							...
							<div className="pb-10" id="mothermother">
								...
								<div className="grid grid-cols-2 md:grid-cols-2 grid-auto-rows minmax(150px, auto) mx-1 md:mx-3">
									{collections["halfalive"].slice(4, 8).map((photo: CollectionPhotoProps) => (
										<CollectionThumbnail
											key={photo.imageSrc}
											photo={photo}
											setModalData={setModalData}
							...
							{/* <div className="pb-10" id="mothermother">
								...
								<div className="grid grid-cols-3 md:grid-cols-3 mx-1 md:mx-3">
									{collections["halfalive"].slice(8, 11).map((photo: CollectionPhotoProps) => (
										<CollectionThumbnail
											key={photo.imageSrc}
											photo={photo}
											setModalData={setModalData}
